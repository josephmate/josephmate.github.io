...
I wasn't verify familiar with the class so I started to look around,
...
To make extra sure, I create another experiment that uses reflection
...
We could reproduce this problem with in conjunction with another common mistake that suppresses uncaught exceptions.
...
| Rust       | no       | compiler prevented me | [source](https://github.com/josephmate/java-by-experiments/tree/main/tree_map_corruption/cpp/) |
